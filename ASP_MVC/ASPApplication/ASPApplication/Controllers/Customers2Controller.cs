...
namespace ASPApplication.Controllers
{
    public class Customers2Controller : Controller
    {
        ...
        public Customers2Controller(seminarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CustId,CustName,CustAddr,CustAge")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustId,CustName,CustAddr,CustAge")] Customer customer)
        {
